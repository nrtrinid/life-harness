...
```text
Ask → save chat summary → review suggested durable memories → save selected items → export includes Memory Bank signals
```
...
| Layer | Role | Lifespan |
|-------|------|----------|
| `chatSummaries[]` | Session continuity, recent Ask context | Trimmed in compact export |
...
- **Ask Harness Dev:** after saving a chat summary, shows suggested durable memories + recent Memory Bank list (toggle/delete).
- **Memory screen (`/memory-bank`):** grouped ledger view; toggle active / delete.

## Dogfood

1. Open Ask Harness Dev with seed board loaded.
2. Ask a career/avoidance question; save the chat summary.
3. Review **Suggested durable memories**; save one pattern or rule.
4. Open **Memory** nav; confirm item appears and is active.
